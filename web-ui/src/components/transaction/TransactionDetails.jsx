        ...
        <div className="row">
            <div className="col-sm-12">
                <h3>
                    ...
                    <span style={{color: 'darkblue', marginLeft: '5px'}}>
                        {transaction.uuid}
                    </span>
                    <FaCopy
                        onClick={() => navigator.clipboard.writeText(transaction.uuid).then(() => {
                            toast.info('UUID copied to clipboard');
                        }).catch(err => {
                            toast.error('Failed to copy text: ', err);
                        })}
                        style={{marginLeft: "10px", marginBottom: "10px", cursor: "pointer", verticalAlign: "middle"}}/>
                </h3>
                <hr/>
                <h5>Belongs To</h5>
